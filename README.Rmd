...
With the {bluehistogram} package, we'll live in a different world (🦄 🦄 🦄) where the task is a snap 🫰: 
...
file; which can be done automatically with `usethis::use_package`:
